          ...
          {selectedCC && selectedDegree && pathway && (
            <div className="bg-gradient-to-br from-gray-800 to-gray-900 border border-gray-700 rounded-xl p-6 mb-8">
              ...
              <button
                ...
                className="w-full mt-6 bg-gradient-to-r from-orange-600 to-orange-500 text-white px-8 py-4 rounded-lg text-lg font-semibold hover:from-orange-700 hover:to-orange-600 transition shadow-lg shadow-orange-500/50 flex items-center justify-center"
